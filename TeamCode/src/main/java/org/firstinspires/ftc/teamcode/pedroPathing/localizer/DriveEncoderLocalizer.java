package org.firstinspires.ftc.teamcode.pedroPathing.localizer;
...
public class DriveEncoderLocalizer implements Localizer {
    ...
    public static double STRAFE_WEIGHT = 1.07065041484;
    public static double STRAIGHT_WEIGHT = 1.063439136;
    ...
    public Matrix getRobotDeltas() {
        ...
        // x/forward movement
        returnMatrix.set(0,0, FORWARD_TICKS_TO_INCHES * (STRAIGHT_WEIGHT * (leftFront.getDeltaPosition() + rightFront.getDeltaPosition() + leftRear.getDeltaPosition() + rightRear.getDeltaPosition())));
        //y/strafe movement
        returnMatrix.set(1,0, STRAFE_TICKS_TO_INCHES * (STRAFE_WEIGHT * (-leftFront.getDeltaPosition() +  rightFront.getDeltaPosition()) + STRAFE_WEIGHT * (leftRear.getDeltaPosition() - rightRear.getDeltaPosition())));
        // theta/turning
